...
PKG := bitbucket.org/payfazz/go-starter-kit

# Where to push the docker image.
REGISTRY := docker.internal.payfazz.com

# Which architecture to build (amd64, arm, arm64, ppc64le)
ARCH := amd64
...
.container-$(DOTFILE_IMAGE): bin/$(ARCH)/$(BIN) Dockerfile
	...
	@docker build --label "version=$(VERSION)" -t $(IMAGE):$(VERSION) -f .dockerfile-$(ARCH) .
